...
<html lang="en">
    ...
    <body class="sb-nav-fixed">
       @include('admin.navbar')
        ...
        @include('admin.sidebar')
            ...
            <form action="{{route('UpdateSifarislercomment')}}" method="POST" enctype="multipart/form-data">
                @csrf
  ...
  <div class="mb-3">
    ...
    <input type="text" name="text" class="form-control bg-warning" value="{{$data['basliq']}}" >
   
  </div>

  <div class="mb-3">
    <label for="exampleInputEmail1" class="form-label">Mezmun</label>
    <input type="text" name="coment" class="form-control bg-warning" value="{{$data['mezmun']}}" >
