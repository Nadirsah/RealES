...
<html lang="en">
    ...
    <body class="sb-nav-fixed">
       @include('admin.navbar')
        ...
        @include('admin.sidebar')
            ...
            <form action="{{route('StoreSifarislerComment')}}" method="POST" enctype="multipart/form-data">
                @csrf
  ...
  <div class="mb-3">
    <label for="exampleInputEmail1" class="form-label">Mezmun</label>
    <input type="text" name="coment" class="form-control bg-warning" >
...
<table class="table">
  ...
  @foreach($data as $baza)
    <tr>
      ...
      <td><a href="{{'editSifarislercomment/'.$baza['id']}}"><i class="fa-solid fa-pen-to-square btn btn-info" ></i></a>
      <a href="{{'deleteSifarislercomment/'.$baza['id']}}"><i class="fa-solid fa-trash  btn btn-danger" ></i></a> 
