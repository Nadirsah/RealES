...
<html lang="en">
    ...
    <body class="sb-nav-fixed">
       @include('admin.navbar')
        ...
        @include('admin.sidebar')
            ...
            <form action="{{route('Storereyler')}}" method="POST" enctype="multipart/form-data">
                @csrf
  <div class="mb-3">
  ...
  <div class="mb-3">
    ...
    <input type="text" name="name" class="form-control bg-warning" >
   
  </div>

  <div class="mb-3">
    <label for="exampleInputEmail1" class="form-label">Rey</label>
    <input type="text" name="comment" class="form-control bg-warning" >
...
<table class="table">
  ...
  @foreach($data as $baza)
    <tr>
      ...
      <td>{{$baza->name}}</td>
      <td>{{$baza->comment}}</td>
      <td><a href="{{'editreyler/'.$baza['id']}}"><i class="fa-solid fa-pen-to-square btn btn-info" ></i></a>
      <a href="{{'deletereyler/'.$baza['id']}}"><i class="fa-solid fa-trash  btn btn-danger" ></i></a>
