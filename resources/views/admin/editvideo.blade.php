...
<html lang="en">
  ...
  <div class="mb-3">
    ...
    <input type="file" name="image" class="form-control bg-warning" value="{{$data['video']}}" >
   
  </div>

  <div class="mb-3">
    <label for="exampleInputEmail1" class="form-label">Ad</label>
    <input type="text" name="name" class="form-control bg-warning" value="{{$data['basliq']}}" >
   
  </div>

  <div class="mb-3">
    <label for="exampleInputEmail1" class="form-label">Haqinda</label>
    <input type="text" name="text" class="form-control bg-warning" value="{{$data['text']}}" >
