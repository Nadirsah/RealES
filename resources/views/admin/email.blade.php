...
<html lang="en">
    ...
    <body class="sb-nav-fixed">
       @include('admin.navbar')
        ...
        @include('admin.sidebar')
            ...
            <form action="{{route('storeemail')}}" method="POST" enctype="multipart/form-data">
                @csrf
  <div class="mb-3">
  ...
  <div class="mb-3">
    ...
    <input type="email" name="email" class="form-control bg-warning" >
...
<table class="table">
 ...
 @foreach($data as $baza)
    <tr>
      ...
      <td>{{$baza->image}}</td>
      <td>{{$baza->email}}</td>
      <td><a href="{{'EditEmail/'.$baza['id']}}"><i class="fa-solid fa-pen-to-square btn btn-info" ></i></a>
      <a href="{{'deleteemail/'.$baza['id']}}"><i class="fa-solid fa-trash  btn btn-danger" ></i></a>
