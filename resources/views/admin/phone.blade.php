...
<html lang="en">
    ...
    <body class="sb-nav-fixed">
       @include('admin.navbar')
        ...
        @include('admin.sidebar')
            ...
            <form action="{{route('storephone')}}" method="POST" enctype="multipart/form-data">
                @csrf
  <div class="mb-3">
  ...
  <div class="mb-3">
    ...
    <input type="text" name="tel" class="form-control bg-warning" >
...
<table class="table">
 ...
 @foreach($data as $baza)
    <tr>
      ...
      <td>{{$baza->image}}</td>
      <td>{{$baza->tel}}</td>
      <td><a href="{{'EditPhone/'.$baza['id']}}"><i class="fa-solid fa-pen-to-square btn btn-info" ></i></a>
      <a href="{{'deletePhone/'.$baza['id']}}"><i class="fa-solid fa-trash  btn btn-danger" ></i></a>
